...
public class QueryChainCodeController {
    ...
    @Autowired
    private AgricultureUtils myUtils;
    ...
    public String queryChainCode(String id) throws Exception {
        ...
        Peer peer0 = fabricClient.getPeer("",path.peer0Grpc,path.tlsPeerFilePath);
...
//        Map<Object, String> map = fabricClient.queryChainCode(peers, path.channelName, TransactionRequest.Type.GO_LANG, path.chainCodeName, "query", initArgs);
        String map = fabricClient.queryChainCode(peers, path.channelName, TransactionRequest.Type.GO_LANG, path.chainCodeName, "query", initArgs);
        log.info("查询到的信息："+map);
...
//    }
    ...
    @ResponseBody
    public ReturnCodeUtil queryChainCode1(@RequestBody String id) throws Exception {
//        public String queryChainCode1(String id) throws Exception {
//        String id = param.getSaleOnlyKey();
        UserContext userContext = new UserContext();
        userContext.setAffiliation("Org2");
        userContext.setMspId("Org2MSP");
        userContext.setAccount("zdd");
        ...
        List<com.fabric.po.CommonUse> commonUses = myUtils.toListMap(s);
...
//        listOrderedMap.put("traces",commonUses);
        System.out.println(commonUses.toString());
        ReturnCodeUtil returnCodeUtil = new ReturnCodeUtil();
        returnCodeUtil.setData(commonUses);
