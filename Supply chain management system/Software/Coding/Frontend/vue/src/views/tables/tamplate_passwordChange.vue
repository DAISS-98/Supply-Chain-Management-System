...
<!--    >-->
      ...
      <el-form-item label="密码" prop="temperature">
        <el-input v-model="allData.editData.account" type="password" placeholder="请输入新密码"  maxlength="20"   />
      </el-form-item>
      <el-form-item label="密码确认" prop="envHumidity">
        <el-input v-model="allData.editData.password" type="password" placeholder="请输入再次输入密码" maxlength="20"  />
      </el-form-item>
