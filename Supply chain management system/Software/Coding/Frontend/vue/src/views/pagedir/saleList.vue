    ...
    >
            <el-form status-icon label-width="100px" ref="formRef" :model="allData.editData" >
              <el-form-item label="上架时间" prop="saleOnDate">
                <el-date-picker
                    v-model="allData.editData.saleOnDate"
                    type="datetime"
                    placeholder="Select date and time"
                />
              </el-form-item>
              <el-form-item label="新鲜度(%)" prop="saleFresh">
                <el-input v-model="allData.editData.saleFresh" placeholder="请输入新鲜度(%)"  />
              </el-form-item>
              <el-form-item label="环境温度(C)" prop="saleC">
                <el-input v-model="allData.editData.saleC" placeholder="请输入环境温度"  />
              </el-form-item>
              <el-form-item label="环境湿度(%)" prop="saleHumidity">
                <el-input v-model="allData.editData.saleHumidity" placeholder="请输入环境湿度"  />
              </el-form-item>
              <el-form-item label="销售员" prop="salePerson">
                <el-input v-model="allData.editData.salePerson" placeholder="请输入销售员"  />
              </el-form-item>
              <el-form-item label="销售单价(元/斤)" prop="salePrice">
                <el-input v-model="allData.editData.salePrice" placeholder="请输入销售单价"  />
              </el-form-item>
            </el-form>
...
<!--      <el-table-column prop="storeOther" label="其他" width="150"/>-->
      <el-table-column prop="saleName" label="本级经销商名称" width="150"/>
      <el-table-column   label="上架时间" width="160" >
        <template #default="scope">
          <text  >{{getTime(scope.$index, scope.row,"saleOnDate")}}</text>
        </template>
      </el-table-column>
      <el-table-column prop="saleFresh" label="新鲜度" width="150"/>
      <el-table-column prop="saleC" label="环境温度(C)" width="150"/>
      <el-table-column prop="saleHumidity" label="环境湿度(%)" width="150"/>
      <el-table-column prop="salePerson" label="销售员" width="150"/>
      <el-table-column prop="salePrice" label="销售单价(元/斤)" width="150"/>
