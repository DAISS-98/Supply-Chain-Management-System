...
<!--                <el-input v-model="allData.editData.processName" placeholder="请输入加工商名称"  />-->
<!--              </el-form-item>-->
              <el-form-item label="进货时间" prop="processGetDate">
                <el-date-picker
                    v-model="allData.editData.processGetDate"
                    type="datetime"
                    placeholder="Select date and time"
                />
              </el-form-item>
              <el-form-item label="加工日期" prop="processTime">
                <el-date-picker
                    v-model="allData.editData.processTime"
                    type="datetime"
                    placeholder="Select date and time"
                />
              </el-form-item>
              <el-form-item label="加工地点" prop="processAddress">
                <el-input v-model="allData.editData.processAddress" placeholder="请输入加工地点"  />
                <el-link :href="getProduceAddress(allData.editData.processAddress)" target="_blank">检索详细地址</el-link>
              </el-form-item>
              <el-form-item label="加工人员" prop="processPerson">
                <el-input v-model="allData.editData.processPerson" placeholder="请输入加工人员"  />
              </el-form-item>
              <el-form-item label="新鲜度(%)" prop="processFresh">
                <el-input v-model="allData.editData.processFresh" placeholder="请输入新鲜度(%)"  />
              </el-form-item>
              <el-form-item label="环境温度" prop="processC">
                <el-input v-model="allData.editData.processC" placeholder="请输入环境温度"  />
              </el-form-item>
              <el-form-item label="环境湿度(%)" prop="processHumidity">
                <el-input v-model="allData.editData.processHumidity" placeholder="请输入环境湿度(%)"  />
              </el-form-item>
