    ...
    >
            <el-form status-icon label-width="100px" ref="formRef" :model="allData.editData" >
              <el-form-item label="仓储地点" prop="storeAddress">
                <el-input v-model="allData.editData.storeAddress" placeholder="请输入仓储地点"  />
                <el-link :href="getProduceAddress(allData.editData.storeAddress)" target="_blank">检索详细地址</el-link>
              </el-form-item>
              <el-form-item label="管理员" prop="storePerson">
                <el-input v-model="allData.editData.storePerson" placeholder="请输入管理员"  />
              </el-form-item>
              <el-form-item label="入库时间" prop="storeIntime">
                <el-date-picker
                    v-model="allData.editData.storeIntime"
                    type="datetime"
                    placeholder="Select date and time"
                />
              </el-form-item>
              <el-form-item label="入库新鲜度" prop="storeFresh">
                <el-input v-model="allData.editData.storeFresh" placeholder="请输入出发时新鲜度(%)"  />
              </el-form-item>
              <el-form-item label="仓储温度(C)" prop="storeC">
                <el-input v-model="allData.editData.storeC" placeholder="请输入仓储温度"  />
              </el-form-item>
              <el-form-item label="仓储其他信息" prop="storeInfo">
                <el-input v-model="allData.editData.storeInfo" placeholder="请输入仓储其他信息"  />
              </el-form-item>
              <el-form-item label="其他" prop="storeOther">
                <el-input v-model="allData.editData.storeOther" placeholder="请输入其他"  />
              </el-form-item>
            </el-form>
