...
<!--   用户  -->
        <el-form-item label="企业名称" label-width="80px" prop="saleName">
          <el-input  placeholder="请输入企业名称" disabled="true" v-model="param.data.saleName">
          </el-input>
        </el-form-item>
        <el-form-item  label="企业地址" label-width="80px" prop="saleAddress">
          <el-input  placeholder="请输入企业地址" disabled="true" v-model="param.data.saleAddress">
          </el-input>
        </el-form-item>
        <el-form-item  label="企业法人" label-width="80px" prop="saleLegalPerson">
          <el-input  placeholder="请输入企业法人" disabled="true" v-model="param.data.saleLegalPerson">
          </el-input>
        </el-form-item>
...
function getData() {
  baseData
      .viewSaleUser({userId:localStorage.getItem("userId")})
      .then((res) => {
