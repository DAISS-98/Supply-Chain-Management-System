  ...
  <base-table>
    <div class="container">
      ...
      <el-form status-icon label-width="100px" ref="formRef" :model="allData.form" >
        ...
        <el-form-item label="报告上传" prop="selfTestGuid">
      ...
      <el-form status-icon label-width="100px" ref="formRef" :model="allData.form" >
        ...
        <el-form-item label="报告上传" prop="otherTestGuid">
      ...
      <div class="login-btn1">
        <el-row>
          <el-col>
            <el-button type="primary" @click="addData">确定修改</el-button>
          </el-col>
        </el-row>
      </div>
      <!--    <template>-->
...
function getData() {
  ...
  baseData
      .viewBreedData({breedOnlyKey:key})
      .then((res) => {
