...
<!--   用户  -->
        <el-form-item  label="企业名称"  label-width="80px" prop="transportName">
          <el-input  placeholder="请输入企业名称"  disabled="true" v-model="param.data.transportName">
          </el-input>
        </el-form-item>
        <el-form-item  label="企业地址"  label-width="80px" prop="transportAddress">
          <el-input  placeholder="请输入企业地址" disabled="true" v-model="param.data.transportAddress">
          </el-input>
        </el-form-item>
        <el-form-item label="企业法人"  label-width="80px" prop="transportLegalPerson">
          <el-input  placeholder="请输入企业法人" disabled="true" v-model="param.data.transportLegalPerson">
          </el-input>
        </el-form-item>
...
function getData() {
  baseData
      .viewTransportUser({userId:localStorage.getItem("userId")})
      .then((res) => {
