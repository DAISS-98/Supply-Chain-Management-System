...
// 侧边栏
const items = [
  { icon: 'el-icon-ali-home', index: '/dashboard3', title: '系统首页' },
  // {
  //   icon: 'el-icon-ali-cascades',
  //   index: '1',
  //   title: '产品信息',
  //   subs: [
  //     { index: '/superviseProductInfo', title: '详细信息' }
  //   ],
  // },
  {
    icon: 'el-icon-ali-cascades',
    ...
    title: '报告管理',
    subs: [
      { index: '/superviseList', title: '日常巡查' },
      { index: '/officialSuperviseList', title: '官方抽检' }
    ],
  },
  {
    icon: 'el-icon-ali-cascades',
